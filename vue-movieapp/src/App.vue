...
<template>
  <header class="sticky top-0 h-20 pt-4 bg-primary z-10">
    <div class="flex text-center justify-center gap-10">
      <RouterLink to="/">
        <button class="btn btn-xs btn-md">Home</button>
      </RouterLink>
  ...
  <footer
    class="footer items-center p-4 bg-primary text-neutral-content sticky bottom-0"
  >
